...
const ProfilePage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-start p-4 pt-0 w-full bg-slate-900 min-h-screen text-slate-100">
      <PageHeader title="Profile Page" />
      {/* Profile Section */}
      <div className="bg-white shadow-lg mt-6 text-black rounded-lg p-6 w-full max-w-xl text-center">
        {/* Background Image */}
        ...
        <div className="mt-20 grid grid-cols-2 gap-4 text-left">
          ...
          <p>
            <span className="font-bold">Phone:</span> {userData.mobileNo}
          </p>
          <p>
            <span className="font-bold">DOB:</span> {userData.dob}
          </p>
          <p>
        ...
        <div className="grid grid-cols-2 gap-4 mt-6 text-sm">
          <button
            ...
            className="flex items-center justify-center p-3 bg-[#762140] text-white rounded-lg hover:bg-[#762140]"
          >
            📄 Create Bio Data
          </button>
          <button
