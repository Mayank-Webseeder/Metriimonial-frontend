    ...
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="bg-gray-200 p-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <input
            type="text"
            placeholder="Search by location, subcaste"
      ...
      <Link to="/saved-profiles"  className=" px-4 py-2 rounded-md">Biodata</Link>
        ...
        <Link to="/saved-dharmashala" className="border px-4 py-2 bg-red-900 text-white rounded-md">Dharmshala</Link>
        ...
        {filteredProfiles.length > 0 ? (
          filteredProfiles.map((profile, index) => (
            <div key={index} className="bg-white p-4 rounded-lg shadow-md">
              ...
              />
              <h3 className="font-bold text-lg mt-2">{profile.location}</h3>
...
export default SavedDharmashala;
